          ...
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="inline-flex items-center space-x-3 group mb-6">
              <div className="relative">
                ...
                <img src="/harryyOmLogo.png" alt="Harryy Om Logo" loading="lazy" decoding="async" className="relative w-12 h-12 group-hover:scale-110 transition-transform duration-300" />
              </div>
