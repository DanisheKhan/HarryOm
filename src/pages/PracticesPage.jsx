    ...
    <div className="w-full">
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-gray-50">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          >
            <span className="px-6 py-2 bg-gray-100 text-gray-700 rounded-full text-sm font-semibold border border-gray-200 flex items-center gap-2">
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-white to-sky-50/30">
        <div className="max-w-3xl mx-auto text-center">
          <span className="px-4 py-2 bg-sky-100 text-sky-700 rounded-full text-sm font-semibold mb-6 flex items-center gap-2 w-fit mx-auto">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            {practices.map((practice, index) => (
              ...
              >
                <div className="relative overflow-hidden h-52">
                  ...
                  <div className="absolute top-4 right-4 w-14 h-14 bg-white/90 rounded-2xl flex items-center justify-center text-sky-600 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-24 px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          ...
          >
            <span className="px-4 py-2 bg-purple-100 text-purple-700 rounded-full text-sm font-semibold mb-6 flex items-center gap-2 w-fit">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-purple-50 rounded-3xl p-8 shadow-sm border border-purple-100">
              ...
              <button
                className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold rounded-full py-4 px-6 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02] transform"
              >
