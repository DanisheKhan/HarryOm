    ...
    <div className="w-full">
      ...
      <section className="relative h-[65vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-sky-900 via-purple-900 to-pink-900">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <motion.h1
            className="text-5xl md:text-7xl font-bold text-white mb-8 font-serif leading-tight"
            initial="hidden"
            animate="visible"
            variants={fadeIn}
          >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-1/3">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start group">
                  <div className="w-14 h-14 bg-gradient-to-br from-sky-100 to-sky-200 rounded-2xl flex items-center justify-center mr-5 shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                {/* Phone */}
                <div className="flex items-start group">
                  <div className="w-14 h-14 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl flex items-center justify-center mr-5 shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                {/* Location */}
                <div className="flex items-start group">
                  <div className="w-14 h-14 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mr-5 shrink-0 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="pt-8">
                  ...
                  <div className="flex space-x-4">
                    {/* Instagram */}
                    <a href="https://instagram.com" target="_blank" rel="noreferrer" className="w-12 h-12 bg-gradient-to-br from-purple-600 to-pink-500 rounded-xl flex items-center justify-center text-white hover:shadow-lg hover:scale-110 transition-all duration-300">
            ...
            <div className="w-full lg:w-2/3">
              <div className="bg-gradient-to-br from-white to-sky-50/30 p-10 md:p-12 rounded-3xl shadow-2xl border border-gray-100">
                <div className="mb-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                    ...
                    <button
                      type="submit"
                      className="bg-gradient-to-r from-sky-500 to-purple-500 hover:from-sky-600 hover:to-purple-600 text-white font-bold px-10 py-4 rounded-full transition-all shadow-lg hover:shadow-xl hover:scale-105 transform whitespace-nowrap"
                    >
                      Send Message
                    </button>
                  </div>
      ...
      {/* Workshops & Sessions */}
      <section className="py-24 px-4 md:px-8 bg-gradient-to-b from-sky-50/30 via-white to-purple-50/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-4 right-4 bg-sky-500 text-white text-xs font-bold uppercase py-2 px-4 rounded-full shadow-lg">
                  Virtual
                </div>
              </div>

              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-sky-600 transition-colors">Inner Alchemy Workshop</h3>
                <p className="text-gray-500 font-medium mb-5 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  July 18-19, 2023 • 10:00 AM - 1:00 PM IST
                </p>
                <p className="text-gray-600 mb-8 leading-relaxed">A two-day intensive on transforming emotional patterns and awakening your highest potential.</p>

                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">₹2,500</span>
                  <button className="bg-gray-100 hover:bg-sky-500 hover:text-white text-gray-800 font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-md">
                    Learn More
                  </button>
                </div>
              </div>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute top-4 right-4 bg-emerald-500 text-white text-xs font-bold uppercase py-2 px-4 rounded-full shadow-lg">
                  In Person
                </div>
              </div>

              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-sky-600 transition-colors">Sacred Relationships Retreat</h3>
                <p className="text-gray-500 font-medium mb-5 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  August 5-7, 2023 • Goa, India
                </p>
                <p className="text-gray-600 mb-8 leading-relaxed">A weekend immersion into the art of conscious relationships and authentic connection.</p>

                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">₹15,000</span>
                  <button className="bg-gray-100 hover:bg-sky-500 hover:text-white text-gray-800 font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-md">
                    Learn More
                  </button>
                </div>
            ...
            >
              <div className="relative h-64 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
                <div className="absolute top-4 right-4 bg-purple-500 text-white text-xs font-bold uppercase py-2 px-4 rounded-full shadow-lg">
                  Hybrid
                </div>
              </div>

              <div className="p-8">
                <h3 className="text-2xl font-bold mb-3 text-gray-900 group-hover:text-sky-600 transition-colors">Soul Purpose Discovery</h3>
                <p className="text-gray-500 font-medium mb-5 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                  </svg>
                  September 12, 2023 • 3:00 PM - 6:00 PM IST
                </p>
                <p className="text-gray-600 mb-8 leading-relaxed">Uncover your unique gifts and align with your soul's mission in this transformative session.</p>

                <div className="flex justify-between items-center">
                  <span className="text-2xl font-bold bg-gradient-to-r from-sky-600 to-purple-600 bg-clip-text text-transparent">₹3,500</span>
                  <button className="bg-gray-100 hover:bg-sky-500 hover:text-white text-gray-800 font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-md">
                    Learn More
                  </button>
                </div>
          ...
          <div className="mt-16 text-center">
            <a href="#" className="inline-flex items-center gap-2 text-sky-600 hover:text-sky-700 font-semibold text-lg group">
      ...
      <section className="py-24 px-4 md:px-8 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {/* FAQ Item 1 */}
            <motion.div
              className="bg-gradient-to-br from-white to-sky-50/50 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100"
            ...
            {/* FAQ Item 2 */}
            <motion.div
              className="bg-gradient-to-br from-white to-purple-50/50 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* FAQ Item 3 */}
            <motion.div
              className="bg-gradient-to-br from-white to-emerald-50/50 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            {/* FAQ Item 4 */}
            <motion.div
              className="bg-gradient-to-br from-white to-amber-50/50 rounded-2xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
          ...
          <div className="mt-12 text-center">
            ...
            <a href="#contact-form" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-sky-500 to-purple-500 hover:from-sky-600 hover:to-purple-600 text-white rounded-full font-bold transition-all shadow-lg hover:shadow-xl hover:scale-105 transform">
